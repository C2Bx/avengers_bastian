 ...
 */
final class Version20240321063017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD adresse_id INT DEFAULT NULL, DROP adresse');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD adresse VARCHAR(255) NOT NULL, DROP adresse_id');
    }
}
